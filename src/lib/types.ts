...
export const NODE_TYPES_CONFIG: Record<string, { title: string, inputTypes: string[], outputTypes: string[], inputLabels: string[], outputLabels: string[], color: string, defaultWidth: number }> = {
    ...
    'findWinnerNode': { title: 'Find Winner', inputTypes: ['VOTECOUNTRIDINGTABLE'], outputTypes: ['RIDINGPARTYTABLE'], inputLabels: ['Table'], outputLabels: ['Winners'], color: '#dd6b20', defaultWidth: 180 },
    'collateWinnersNode': { title: 'Collate Winners', inputTypes: ['RIDINGPARTYTABLE'], outputTypes: ['COLLATEDPARTYTABLE'], inputLabels: ['Winners'], outputLabels: ['Seats'], color: '#805ad5', defaultWidth: 180 },
    ...
    'filterPartyNode': { title: 'Filter by Party', inputTypes: ['RIDINGPARTYTABLE', 'PARTY'], outputTypes: ['RIDINGPARTYTABLE', 'RIDINGPARTYTABLE'], inputLabels: ['Table', 'Party'], outputLabels: ['Is Party', 'Is Not Party'], color: '#ed8936', defaultWidth: 200 },
    ...
    'convertToPercentagesRidingNode': {title: 'Convert Riding Table To Percentages', inputTypes: ['VOTECOUNTRIDINGTABLE'], outputTypes: ['VOTECOUNTRIDINGTABLE'], inputLabels: ['Riding Vote Count Table'], outputLabels: ['Percentages Table'], color: '#dd6b20', defaultWidth: 200},
    'convertToPercentagesCollatedNode': {title: 'Convert Collated Table To Percentages', inputTypes: ['COLLATEDVOTETABLE'], outputTypes: ['COLLATEDVOTETABLE'], inputLabels: ['Collated Vote Count Table'], outputLabels: ['Percentages Table'], color: '#dd6b20', defaultWidth: 200},
    ...
    'extractCollatedNode': { title: 'Extract Value', inputTypes: ['ANYCOLLATEDTABLE', 'PARTY'], outputTypes: ['FLOAT'], inputLabels: ['Table', 'Party'], outputLabels: ['Count'], color: '#f56565', defaultWidth: 180 },
